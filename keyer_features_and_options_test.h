...
#define OPTION_WINKEY_DO_NOT_ECHO_7C_BYTE                    // Might need for UCXlog? (7C = half space character)
#define OPTION_WINKEY_DO_NOT_SEND_7C_BYTE_HALF_SPACE         // Might need for UCXlog? 
